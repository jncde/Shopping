...
<div class="shell">
  ...
  <div id="main">
          ...
          <li class="<%=last%>"> <a href="productdetailshow.jsp?id=<%=p.getId()%>"><img src="css/images/big1.jpg" alt="" /></a>
            <div class="product-info">
              ...
              <div class="product-desc">
                <h4><%=p.getDescr() %></h4>
                <p>市场价:<%=p.getNormalPrice() %><br />
                  &nbsp;</p>
                <strong class="price">会员价:<%=p.getMemberPrice()%></strong> </div>
            </div>
          </li>
          <% } %><!--
	...
	<!--end login-->
      <!-- Search -->
	  <p> <a href="login.jsp" class="bul">登录</a><br />
              <a href="register.jsp" class="bul">用户注册</a> </p>
  ...
  <div class="side-full">
    ...
    <div class="cols">
      ...
      <div class="col">
        ...
        <p><a title="" href="http://www.88web.org/"></a></p>
        <p class="more"><a href="#" class="bul">Lorem ipsum</a></p>
      </div>
      <div class="col">
  ...
  <div id="footer">
    ...
    <p class="right"> &copy; 2010 Shop Around. Design by <a href="http://88web.org"></a> </p>
  </div>
  <!-- End Footer -->
</div>
<!-- End Shell -->
